...
- **config**
  ...
  - **Description:** Manage the CLI configuration. The "view" subcommand displays the current configuration, and the "set" subcommand updates a configuration key with a new value in the `config.json` file.
