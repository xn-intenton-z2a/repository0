...
- **config**
  ...
  - **Description:** Manage CLI configuration. Use the "view" subcommand to inspect the current configuration and the "set" subcommand to update a configuration key in the `config.json` file.
