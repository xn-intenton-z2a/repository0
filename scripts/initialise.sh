...
cp -fv "seeds/zero-README.md.txt"  README.md
cp -fv "seeds/zero-package.json.txt"  package.json
cp -fv "seeds/zero-main.js.txt" src/lib/main.js
cp -fv "seeds/zero-main.test.js.txt" tests/unit/main.test.js
rm -rfv node_modules
